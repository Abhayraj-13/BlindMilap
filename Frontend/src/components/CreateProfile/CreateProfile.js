...
// import NavBar from '../NavBar';
// // import { navigate } from 'react-router-dom';
// import { auth, signOut } from "../../firebase"; // Make sure you're importing auth correctly
...
//   const [uid, setUid] = useState(''); // Add state to store the uid
...
//   const handleAvatarSubmit = async (avatarUrl) => {
//     const combinedData = { ...formData, profile_avatar: avatarUrl, uid };
//     console.log('Submitting:', combinedData);
...
import NavBar from '../NavBar';
// import { navigate } from 'react-router-dom';
import { auth,getAuth, GoogleAuthProvider, signOut } from "../../firebase";
import { onAuthStateChanged } from "firebase/auth"; // Import onAuthStateChanged
...
const [showFeed, setShowFeed] = useState(true);
const [showProfileCard, setShowProfileCard] = useState(false); // Add state to control rendering of CreateProfileCard
const [uid, setUid] = useState(null); // Add state to store the uid
